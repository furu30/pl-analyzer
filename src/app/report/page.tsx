    ...
    <>
      ...
      <style jsx global>{`
        @media print {
          ...
          /* 色付き行 */
          .bg-sales td { background: #E2EFDA !important; -webkit-print-color-adjust: exact; print-color-adjust: exact; }
          .bg-variable td { background: #FFF2CC !important; -webkit-print-color-adjust: exact; print-color-adjust: exact; }
          .bg-fixed td { background: #FCE4D6 !important; -webkit-print-color-adjust: exact; print-color-adjust: exact; }
          .bg-profit td { background: #FCE4EC !important; -webkit-print-color-adjust: exact; print-color-adjust: exact; }
          .bg-marginal td { background: #E2EFDA !important; -webkit-print-color-adjust: exact; print-color-adjust: exact; }
